# Structure decisions
According to [this](https://redux.js.org/docs/faq/CodeStructure.html), using the Redux library we can chose the type of structure of our project. I chose to use the "Rails-style" code structure because I found it to be very pleasant. 
...
## TODO REMOVE ALL FROM THIS POINT ON
